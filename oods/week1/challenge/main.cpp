 ...
 * and a public member function named sum() that has no arguments but adds the two member
 * variables together and returns their sum.
 */

// Remove the following when submitting
#include <iostream>
